...
- [Quest objective routing](dbz-kakarot-quest-objective-routing.md) — every objective kind (fish, talk, deliver, hunt, defeat, arrive): the phase classes and their target members, the find-id → actor resolvers, why RANGE_ONLY markers miss the spot, and the resolver design + verification plan (2026-09-08, not built).
