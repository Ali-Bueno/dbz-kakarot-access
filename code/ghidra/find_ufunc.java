...
public class find_ufunc extends GhidraScript {
    static final String OUT_DIR =
        "D:\\code\\unreal\\dragon ball kakarot access\\code\\decompiled";
    static final String[] NAMES = {
        "SetFontType", "SetFontTypeWithCategory", "IsFinishSetFontType",
        "MouseClickTabLeft", "MouseClickTabRight", "MouseClickDecide",
        "CheckHovered", "OnEnterAnimEnd", "GetSelectValue",
    };
