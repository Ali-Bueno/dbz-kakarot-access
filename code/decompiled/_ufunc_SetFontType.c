// UFunction 'SetFontType' — exec thunk(s) + native impl (via UE native-registration table)
...
// ---- FUN_1417bfeb0 @ 1417bfeb0 ----

longlong FUN_1417bfeb0(void)

{
  if (DAT_1459b3698 == 0) {
    FUN_14203aad0(&DAT_1459b3698,&PTR_FUN_1454f2dd0);
  }
  return DAT_1459b3698;
}
