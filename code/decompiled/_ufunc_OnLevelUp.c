// UFunction 'OnLevelUp' — exec thunk(s) + native impl (via UE native-registration table)
// ---- FUN_141759640 @ 141759640 ----

longlong FUN_141759640(void)

{
  if (DAT_145996460 == 0) {
    FUN_14203aad0(&DAT_145996460,&PTR_FUN_145461630);
  }
  return DAT_145996460;
}
...
// ---- FUN_14175b490 @ 14175b490 ----

void FUN_14175b490(undefined8 param_1,longlong param_2)

{
  ...
  *(ulonglong *)(param_2 + 0x20) =
  ...
  FUN_140f14540(param_1,local_res10);
  return;
}
