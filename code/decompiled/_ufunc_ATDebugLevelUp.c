// UFunction 'ATDebugLevelUp' — exec thunk(s) + native impl (via UE native-registration table)
...
// ---- FUN_14181f1a0 @ 14181f1a0 ----

longlong FUN_14181f1a0(void)

{
  if (DAT_1459d5210 == 0) {
    FUN_14203aad0(&DAT_1459d5210,&PTR_FUN_145563690);
  }
  return DAT_1459d5210;
}
