// ---- FUN_1417b9d40 @ 1417b9d40 ----

longlong FUN_1417b9d40(void)

{
  if (DAT_1459b1820 == 0) {
    FUN_14203aad0(&DAT_1459b1820,&PTR_FUN_1454e8b60);
  }
  return DAT_1459b1820;
}
...
// ---- FUN_1417bb1c0 @ 1417bb1c0 ----

void FUN_1417bb1c0(longlong param_1,longlong param_2)
  ...
  *(ulonglong *)(param_2 + 0x20) =
  ...
  if (((-1 < iVar1) && (iVar1 < *(int *)(param_1 + 0x430))) &&
    ...
    if ((char)plVar2[0x80] == '\0') {
      (**(code **)(*plVar2 + 0x2e8))(plVar2,plVar2[0x7f]);
      ...
      if (plVar3 != (longlong *)0x0) {
        (**(code **)(*plVar3 + 0x250))(plVar3,0);
        (**(code **)(*(longlong *)plVar2[0x7b] + 0x250))((longlong *)plVar2[0x7b],0);
      }
      (**(code **)(*plVar2 + 0x2e0))(plVar2,plVar2[0x7d],0,1,0,DAT_1450d6c88);
      *(undefined2 *)(plVar2 + 0x80) = 1;
    }
    return;
  }
  return;
